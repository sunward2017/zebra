...
import WorkGroup from './GroupInfo'
import OwnerInfoForm from './OwnerInfo'
import ReconnaissanceForm from './ReconnaissanceReport'
...
export class Inspection extends React.Component {
  ...
  getReport = () => {
    ...
    switch (type) {
      ...
      case 'workCalendar':
        return <WorkCalendar zebracrossingId={zebracrossingId} />
      case 'workOwner':
        return <OwnerInfoForm zebracrossingId={zebracrossingId} />
      case 'workGroup':
        return <WorkGroup zebracrossingId={zebracrossingId} />
      case 'reconnaissanceForm':
        return <ReconnaissanceForm zebracrossingId={zebracrossingId} />
      default:
        return null;
    }
  }
          ...
          <Col span={4}>
            <Card style={{ textAlign: 'center' }}>
              <Button
                ...
                icon="file-word"
                type="primary"
                onClick={() => { this.changeReport('reconnaissanceForm') }}
              >
                勘察报告
               </Button>
              <br />
              <Button
                ...
                icon="file-word"
                type="primary"
                onClick={() => { this.changeReport('workOwner') }}
              >
                施工业主
               </Button>
              <br />
              <Button
                ...
                icon="file-word"
                type="primary"
                onClick={() => { this.changeReport('workGroup') }}
              >
                施工团队
               </Button>
              <br />
