...
export class zebraCrossing extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      treeNodeData: [],
  ...
  handleAddNewZebraCrossing = () => {
    ...
    let { longitude, latitude } = this.state.selectedCrossing;
    this.setState({
      action: '',
      addBtnFlag: true,
      lng:longitude,
  ...
  render() {
    const { treeNodeData, crossingList, zebraCrossingList, columns, addBtnFlag, action, editRecord, lng, lat } = this.state;
    return (
